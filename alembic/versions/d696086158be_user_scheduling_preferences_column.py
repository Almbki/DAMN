"""user scheduling preferences column

Revision ID: d696086158be
Revises: 7f9ae3f96ba3
Create Date: 2026-09-22 09:18:45.860173+00:00
...
revision: str = 'd696086158be'
down_revision: Union[str, None] = '7f9ae3f96ba3'
...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('scheduling_preferences', sa.JSON(), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('users', 'scheduling_preferences')
